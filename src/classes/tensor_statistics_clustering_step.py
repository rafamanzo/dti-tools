...
"""Container for TensorStatisticsClusteringStep class"""
...
class TensorStatisticsClusteringStep(Step):
    """Applying the DBSCAN algorithm it elimates clusters points
         according to tensor statistics values
