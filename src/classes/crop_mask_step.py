...
class CropMaskStep(CPUParallelStep):
    ...
    def load_data(self):
        ...
        self.__x_start = sys.argv[2]
        self.__x_end = sys.argv[3]
        self.__y_start = sys.argv[4]
        self.__y_end = sys.argv[5]
        self.__z_start = sys.argv[6]
        self.__z_end = sys.argv[7]
    ...
    def consume_product(self, product):
        self.croped_mask[product] = self.mask[product]
    ...
    def save(self):
        ...
        croped_img.to_filename('%s_croped.nii.gz'%self.file_prefix)
